FILESEXTRAPATHS_prepend_hs2500 := "${THISDIR}/${BPN}:"
...
PACKAGECONFIG_append_hs2500 = " cooling-type"
...
SYSTEMD_ENVIRONMENT_FILE_phosphor-cooling-type_append_hs2500 = " ${@compose_list(d, 'COOLING_ENV_FMT', 'OBMC_CHASSIS_INSTANCES')}"
